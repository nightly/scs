...
namespace scs::examples {
	...
	void RunHinge(const ExecutionType& exec, size_t recipe_variant, bool just_export, bool shuffling, const std::mt19937& rng) {
		std::string dir;
		...
		auto recipe_prog = HingeRecipe(recipe_variant);
